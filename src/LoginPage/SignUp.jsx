...
const SignUp = () => {
    ...
    const handleChange = (e) => {
        ...
        // 🚨 **পরিবর্তিত handleChange ফাংশন শুরু** 🚨
        if (name === "phone") {
            // শুধুমাত্র সংখ্যা (digit) ইনপুট নেওয়ার জন্য ফিল্টার করা
            const numericValue = value.replace(/\D/g, ''); 
            
            // 11 ডিজিটের চেয়ে বেশি ইনপুট দেওয়া যাবে না
            if (numericValue.length > 11) {
                // 11-এর বেশি হলে স্টেট আপডেট করবে না, অর্থাৎ অতিরিক্ত ইনপুট নেবে না
                return; 
            }

            // যদি দৈর্ঘ্য 11-এর কম হয়, তাহলে সংখ্যা ইনপুট করা বন্ধ হবে না, 
            // কিন্তু এটি নিশ্চিত করবে যে শুধু সংখ্যাই সেভ হচ্ছে।
            // ইউজারকে একটি সম্পূর্ণ নম্বর দিতে উৎসাহিত করার জন্য, আপনি সাবমিট হ্যান্ডলারে
            // 11-ডিজিট না হলে এরর দেখাতে পারেন।
            
            setFormData({ ...formData, [name]: numericValue });
            
        } else if (name === "photo" && files && files[0]) {
            // Photo ইনপুট লজিক (আগের মতোই)
            setFormData({ ...formData, photo: files[0] });
            setPreviewImage(URL.createObjectURL(files[0]));
        } else {
            // অন্যান্য ফিল্ডের জন্য সাধারণ আপডেট লজিক (আগের মতোই)
            setFormData({ ...formData, [name]: value });
        }
        // 🚨 **পরিবর্তিত handleChange ফাংশন শেষ** 🚨
    };
    ...
    const handleSubmit = async (e) => {
        ...
        // ⚠️ অতিরিক্ত ভ্যালিডেশন: ফোন নম্বর 11 ডিজিট কিনা তা সাবমিট করার সময় চেক করা।
        if (phone.length !== 11 && phone.length > 0) {
            Swal.fire("⚠️ Warning", "Phone number must be exactly 11 digits long.", "warning");
            return;
        }
        ...
        <div className="min-h-screen signup flex items-center justify-center relative overflow-hidden">
            ...
            >
                ...
                <fieldset className="fieldset">
                    ...
                    {/* Phone Number */}
                    {/* কোডটি অপরিবর্তিত রাখা হলো, শুধু handleChange হ্যান্ডলারের মাধ্যমে লজিক পরিবর্তন করা হয়েছে। */}
